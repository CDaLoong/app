...
```shell
git clone https://github.com/CDaLoong/app.git
```
...
```js
// 用于加密的秘钥
exports.keys = 'DaLoong-blog'; // 为避免安全问题，强烈建议修改该值
```

```js
// 初始化的管理员信息
exports.admin = {
  loginId: 'DaLoong', // 为避免安全问题，强烈建议修改该值
  loginPwd: '123456', // 为避免安全问题，强烈建议修改该值
  name: 'DaLoong',
};
```
